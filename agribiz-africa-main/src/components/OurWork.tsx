        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {workImages.map((image, index) => {
            ...
            return (
              <div
                key={index}
                className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 animate-fade-in-up"
              ...
              >
                ...
                <div className="relative h-56 overflow-hidden">
                  ...
                  <div className="absolute top-3 left-3 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full">
                    <span className="text-xs font-medium text-gray-700">{image.location}</span>
                  </div>
                </div>
