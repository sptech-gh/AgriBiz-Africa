    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 px-4 max-w-4xl mx-auto">
        <div className="prose prose-lg max-w-none">
          ...
          <div className="bg-teal-50 rounded-2xl p-8 my-8">
          ...
          <div className="bg-emerald-50 rounded-2xl p-8 my-8">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-white rounded-xl p-4">
                <h4 className="font-bold text-gray-900 mb-2">Maize</h4>
              ...
              <div className="bg-white rounded-xl p-4">
                <h4 className="font-bold text-gray-900 mb-2">Rice</h4>
              ...
              <div className="bg-white rounded-xl p-4">
                <h4 className="font-bold text-gray-900 mb-2">Vegetables</h4>
      ...
      <section className="py-16 px-4 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          {services.map((service, index) => {
            ...
            return (
              <div key={index} className="bg-gradient-to-br from-gray-50 to-teal-50 rounded-2xl p-8 hover:shadow-lg transition-all duration-300">
        ...
        {/* CTA Section */}
        <div className="mt-16 text-center bg-gradient-to-r from-teal-50 to-cyan-50 rounded-2xl p-8">
          <h3 className="text-2xl font-bold text-gray-900 mb-4">
